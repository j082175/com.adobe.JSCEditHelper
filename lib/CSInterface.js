 ...
 * 이벤트를 발송합니다.
 */
// CSInterface.js - CSXSEvent.prototype.dispatch 수정
CSXSEvent.prototype.dispatch = function () {
    if (this.type && this.type.length > 0) {
        try {
            // this.data는 host.jsx에서 이미 JSON.stringify(eventData)로 문자열화된 페이로드입니다.
            // 따라서 this.data를 직접 전달합니다.
            window.__adobe_cep__.dispatchEvent(this.type, this.data);
        } catch (e) {
