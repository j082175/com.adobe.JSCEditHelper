...
const TextProcessor = (function(): TextProcessorInterface {
    ...
    function getUtils(): JSCUtilsInterface {
        const fallback: JSCUtilsInterface = {
            debugLog: (msg: string, ..._args: any[]) => console.log('[TextProcessor]', msg),
            logDebug: (msg: string, ..._args: any[]) => console.log('[TextProcessor]', msg),
            logInfo: (msg: string, ..._args: any[]) => console.info('[TextProcessor]', msg),
            logWarn: (msg: string, ..._args: any[]) => console.warn('[TextProcessor]', msg),
            logError: (msg: string, ..._args: any[]) => console.error('[TextProcessor]', msg),
    ...
    function getErrorHandler(): any {
        return errorService || (window as any).JSCErrorHandler || {
            ...
            logError: (msg: string, ..._args: any[]) => console.error(`[TextProcessor Error] ${msg}`)
        };
    }
